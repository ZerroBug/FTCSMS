...
<head>
    ...
    <title>Add Academic Year — FTCSMS</title>
                ...
                <div class="col-lg-4">
                    <div class="form-card">
                        ...
                        <div class="header-box mb-4 d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="title-h mb-0">Add Academic Year</h4>
                                <div class="subtitle">Create & manage school years</div>
                            </div>
                        </div>

                        <form action="../handlers/process_add_academic_year.php" method="POST">

                            <div class="mb-3">
                                <label class="form-label">Academic Year <span class="text-danger">*</span></label>
                                <input type="text" name="year_name" class="form-control form-control-lg"
                    ...
                    <div class="form-card">
                        ...
                        <div class="header-box mb-3">
                            <h4 class="title-h mb-0">
                                <i class="fas fa-table me-2"></i> Academic Years
                            </h4>
                        </div>
