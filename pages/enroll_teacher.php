     ...
     <main class="main" id="main">
        ...
        ?>
         ...
         <div class="container-fluid">
             <div class="row g-4">
                 <div class="col-12">
                     <!-- <a href="teacher_template.csv" download class="btn btn-sm px-4 py-2 mb-3 template-download-btn">
                         ...
                         <div class="header-box mb-4 d-flex justify-content-between align-items-center">
                             <div class="d-flex align-items-center gap-2">
                                 ...
                                 <div>
                                     ...
                                     <!-- <div class="subtitle">Create a teacher account or import via CSV</div> -->
                                 </div>
                             </div>

                             <!-- <form action="../handlers/import_teachers_csv.php" method="POST"
     ...
     document.addEventListener('DOMContentLoaded', function() {
         ...
         function handleStaffTypeChange() {
             ...
             if (staffType.value === 'Teaching') {
                 ...
                 // Show subjects (if exists)
                 if (subjectsWrapper && subjectsInput) {
         ...
         handleStaffTypeChange(); // run on load
